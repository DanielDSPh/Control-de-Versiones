...
void CreateShaders()
{
	...
	Shader* shader_cafe = new Shader();//color café [5]
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Comentar la parte de las letras (desde aquí) para visualizar el dibujo de la casa.
		...
		//Termina la parte de las letras. Comentar y descomentar hasta aquí para las letras
		...
		//Árboles. Piramides Verde Obscuro
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		meshList[1]->RenderMesh();
		//Aqui termina la creacion del dibujo. Comentar o descomentar hasta aquí
		*/
